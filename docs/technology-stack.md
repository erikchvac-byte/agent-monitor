...
| **Testing** | Jest | 30.2.0 | JavaScript testing framework (infrastructure ready) |
| **TypeScript Jest** | ts-jest | 29.4.6 | TypeScript transformer for Jest (infrastructure ready) |
...
| **Test** | `npm test` | Jest test runner (infrastructure ready) |
